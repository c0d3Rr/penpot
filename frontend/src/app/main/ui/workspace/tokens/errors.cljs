...
(def error-codes
  {:error.import/json-parse-error
   {:error/code :error.import/json-parse-error
    :error/message (tr "workspace.token.error-parse")}

   :error.import/invalid-json-data
   {:error/code :error.import/invalid-json-data
    :error/message (tr "workspace.token.import-error")}
   ...
   {:error/code :error.token/direct-self-reference
    :error/message (tr "workspace.token.self-reference")}
   ...
   {:error/code :error/unknown
    :error/message (tr "labels.unknown-error")}})
